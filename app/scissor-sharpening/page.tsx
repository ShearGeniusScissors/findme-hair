      ...
      <div className="mx-auto max-w-3xl px-6 py-10 space-y-10">
        ...
        <section className="card p-8 text-sm text-[var(--color-ink-light)] leading-relaxed">
          ...
          <ul className="grid gap-1 mt-2 sm:grid-cols-2">
            <li>· <a href="https://www.sheargenius.com.au/pages/scissor-sharpening-launceston?utm_source=findme.hair&utm_medium=referral&utm_campaign=cross-domain&utm_content=scissor-sharpening-launceston" target="_blank" rel="noopener" className="text-[var(--color-gold-dark)] hover:text-[var(--color-gold)]">Scissor sharpening Launceston</a></li>
            <li>· <a href="https://www.sheargenius.com.au/pages/scissor-sharpening-melbourne?utm_source=findme.hair&utm_medium=referral&utm_campaign=cross-domain&utm_content=scissor-sharpening-melbourne" target="_blank" rel="noopener" className="text-[var(--color-gold-dark)] hover:text-[var(--color-gold)]">Scissor sharpening Melbourne</a></li>
            <li>· <a href="https://www.sheargenius.com.au/pages/scissor-sharpening-devonport?utm_source=findme.hair&utm_medium=referral&utm_campaign=cross-domain&utm_content=scissor-sharpening-devonport" target="_blank" rel="noopener" className="text-[var(--color-gold-dark)] hover:text-[var(--color-gold)]">Scissor sharpening Devonport</a></li>
            <li>· <a href="https://www.sheargenius.com.au/pages/scissor-sharpening-hobart?utm_source=findme.hair&utm_medium=referral&utm_campaign=cross-domain&utm_content=scissor-sharpening-hobart" target="_blank" rel="noopener" className="text-[var(--color-gold-dark)] hover:text-[var(--color-gold)]">Scissor sharpening Hobart</a></li>
            <li>· <a href="https://www.sheargenius.com.au/pages/scissor-sharpening-ballarat?utm_source=findme.hair&utm_medium=referral&utm_campaign=cross-domain&utm_content=scissor-sharpening-ballarat" target="_blank" rel="noopener" className="text-[var(--color-gold-dark)] hover:text-[var(--color-gold)]">Scissor sharpening Ballarat</a></li>
            <li>· <a href="https://www.sheargenius.com.au/pages/scissor-sharpening-bendigo?utm_source=findme.hair&utm_medium=referral&utm_campaign=cross-domain&utm_content=scissor-sharpening-bendigo" target="_blank" rel="noopener" className="text-[var(--color-gold-dark)] hover:text-[var(--color-gold)]">Scissor sharpening Bendigo</a></li>
            <li>· <a href="https://www.sheargenius.com.au/pages/scissor-sharpening-geelong?utm_source=findme.hair&utm_medium=referral&utm_campaign=cross-domain&utm_content=scissor-sharpening-geelong" target="_blank" rel="noopener" className="text-[var(--color-gold-dark)] hover:text-[var(--color-gold)]">Scissor sharpening Geelong</a></li>
            <li>· <a href="https://www.sheargenius.com.au/pages/service-areas?utm_source=findme.hair&utm_medium=referral&utm_campaign=cross-domain&utm_content=service-areas" target="_blank" rel="noopener" className="text-[var(--color-gold-dark)] hover:text-[var(--color-gold)]">Every town on the run</a></li>
          </ul>
        </section>
